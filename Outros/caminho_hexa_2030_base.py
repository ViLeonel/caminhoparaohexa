...
<style>
    ...
    .stApp {
        background-color: #090d16; /* Soft Navy Principal */
        color: #f8fafc; /* Textos Principal Off-White */
    ...
    .app-title {
        ...
        background: linear-gradient(135deg, #eab308 0%, #d97706 40%, #f1f5f9 100%);
    ...
    .project-subtitle {
        color: #94a3b8; /* Cinza Suave para menor impacto */
        font-size: 1.15rem;
        margin-bottom: 2rem;
        line-height: 1.6;
    }
    ...
    div[data-testid="stSidebarNav"] + div[data-testid="stForm"] > div[data-testid="stMarkdownContainer"] + div[class="stFormSubmitButton"] + div > div[data-testid="stWidgetLabel"] + div[data-testid="stMarkdownContainer"] + div[class="stFormSubmitButton"] + div,
    div.stRadio > div[data-testid="stMarkdownContainer"] + div {
        display: none;
    }
    
    /* Estiliza os labels como cards clicáveis */
    div.stRadio > div[role="radiogroup"] > label {
        background-color: #111827; /* Fundo de item não selecionado */
    ...
    div.stRadio > div[role="radiogroup"] > label:hover {
        border-color: #eab308; /* Borda Ouro no Hover */
        color: #eab308;
    }
...
menu = st.sidebar.radio(
    ...
    label_visibility="collapsed" # Esconde o label padrão para usar o CSS customizado
)
...
if menu == "🏟️ Campo de Jogo (Escalação)":
    # [MELHORIA IMAGEM 01]: Título com Gradiente Ouro
    st.markdown(
...
with st.sidebar.form("form_sugestao", clear_on_submit=True):
    # [MELHORIA IMAGEM 04]: Revisão de Labels e Ortografia
    ...
    detalhes_sugestao = st.text_area(
        ...
        placeholder="Se escolheu Jogador: Nome, posição, clube e motivo.\nSe escolheu Melhoria: Ideia de nova tela ou recurso..."
    )
    ...
    if btn_sugestion:
        if detalhes_sugestao:
            ...
            # [MELHORIA UX]: Botão de e-mail estilizado com CSS
